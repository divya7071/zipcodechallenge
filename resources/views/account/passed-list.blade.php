...
<div class="card-box mb-4">
    <h5 class="mb-1">Completed Zips</h5>
    <small class="text-muted">Showing all Completed Zips</small>
        ...
        <div class="col-12">
            <div class="bakix-details-tab">
                <ul class="nav text-center justify-content-center pb-30 mb-30">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('account.completed-zips') ? 'active' : '' }}"
...
$('#load-more-btn').on('click', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#passed-zip-container').append(response.html);
            page++;
