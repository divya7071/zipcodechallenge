                        ...
                        <div class="col-xl-3 col-lg-3 col-sm-6">
                            <div class="footer-widget mb-30">
                                ...
                                <div class="recent-blog-footer">
                                    <ul>
                                        <li>
                                            <div class="thum"> <img src="{{ url("front/img/blog/s-blogimg-01.png")}}" alt="img"></div>
                                            <div class="text"> <a href="#">Nothing impossble to need hard work</a>
                                            <span>7 March, 2020</span></div>
                                        </li>
                                        
                                        <li>
                                            <div class="thum"> <img src="{{ url("front/img/blog/s-blogimg-02.png")}}" alt="img"></div>
                                            <div class="text"> <a href="#">Nothing impossble to need hard work</a>
                                            <span>7 March, 2020</span></div>
                                        </li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                         <div class="col-lg-4">          
                                ...
                                <img src="{{ url("front/img/logo/f_logo.png")}}" alt="img">
                        </div>
                        <div class="col-lg-4">
                          <div class="copy-text">
