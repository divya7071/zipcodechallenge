            ...
            <div class="card-body">
                <div class="d-md-flex gap-4 align-items-center">
                    ...
                    <div class="dropdown ms-auto">
                            @if($strava_status ==1)
                                <a href="{{ route('admin.getActivities') }}" class="btn btn-info" style="align-items:right;" data-aos="fade-up" data-aos-delay="300">Get Activities</a>
                            @endif
                    </div>
                </div>
            </div>
