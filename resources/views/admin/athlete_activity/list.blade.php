...
<div class="mb-4">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Strava Activities</li>
        </ol>
    </nav>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-md-flex gap-4 align-items-center">
                    <div class="d-none d-md-flex">All Activities</div>
                    <div class="d-md-flex gap-4 align-items-center">
                        <form class="mb-3 mb-md-0">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-7">
                                    <select class="form-select" id="athletes" name="athletes">
                                        <option value="">All Athletes</option>
                                        @foreach($athletes as $athlete)
                                        <option value="{{$athlete->id}}" {{$athlete->id==$athelete_id?'selected':''}}>{{$athlete->first_name.' '.$athlete->last_name }}</option>
                                        @endforeach
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $registrationTable = $('#registrations').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("admin.athlete-activity.index") }}',
                data: function(d) {
                    d.athlete_id = '{{$athelete_id}}'
                }
            },
